...
const (
	...
	logHeapArenaBytes = (6+20)*(_64bit*(1-goos.IsWindows)*(1-goarch.IsWasm)*(1-goos.IsIos*goarch.IsArm64)*(1-goos.IsTamago)) + (2+20)*(_64bit*goos.IsWindows) + (2+20)*(1-_64bit)*(1-goos.IsTamago) + (9+10)*goarch.IsWasm + (2+20)*goos.IsIos*goarch.IsArm64 + (goos_overlay.LogHeapArenaBytes)*goos.IsTamago
